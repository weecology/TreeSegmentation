...
## View polygons and underlying points
```{r,eval=F}
...
```{r,eval=T}
system.time(results_all<-evaluate_all(itcs=itcs[1:4],algorithm = c("dalponte","li","watershed","silva"),path_to_tiles=path_to_tiles,cores=cores,extra=F,compute_consensus=F))
