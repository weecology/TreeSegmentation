...
tile<-readLAS(paste("../data/cropped_",fname,sep=""))
...
```{r}
results<-evaluate(ground_truth=itcs[[20]],algorithm = c("silva","dalponte","li","watershed"),path_to_tiles="/Users/ben/Dropbox/Weecology/NEON/cropped_")
...
```{r,eval=T}
system.time(results_all<-evaluate_all(itcs=itcs,algorithm = c("dalponte","silva","li"),path_to_tiles="/Users/ben/Dropbox/Weecology/NEON/cropped_",cores=4))
