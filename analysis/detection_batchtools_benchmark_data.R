...
site_df<-data.frame(Site=c("WOOD","YELL","WLOU","UKFS","SRER","SERC","RMNP","REDB","OAES","NOGP","MOAB","KONZ","HOPB","HEAL","DEJU","CUPE","ABBY","SJER","TEAK","NIWO","MLBS","BART","BLAN","BONA","CLBJ","DELA","DSNY","HARV","JERC","LENO","ONAQ","OSBS","SCBI","SOAP","TALL","UNDE","WREF"),
                    Type=c("D","D","D","D","C","D","D","D","D","D","D","D","D","C","D","D","C","D","C","C","D","D","D","D","D","D","C","D","D","D","C","C","D","D","D","D","C"))
