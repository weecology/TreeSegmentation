...
#set data paths
path_to_tiles=paste("../data/NeonTreeEvaluation/",site,"/samples/",sep="")
basemap=paste("../data/NeonTreeEvaluation/",site,"/samples/",sep="")
...
rgb_tiles<-list.files(paste("/Users/Ben/Documents/DeepLidar/data/",site,"/samples/",sep=""))
...
f<-list.files(paste("../data/NeonTreeEvaluation/",site,"/annotations/",sep=""),pattern="image",full.names = T)
...
lidar_file<-paste("/Users/ben/Documents/TreeSegmentation/data/NeonTreeEvaluation/",site,"/samples/",str_match(plot_name,"(\\w+).tif")[,2],".laz",sep="")
...
r<-stack(paste("../data/NeonTreeEvaluation/",site,"/samples/",plot_name,sep=""))
...
run_all<-function(plots,dat){
  ...
  algorithms<-c("Silva","Dalponte","Li")
